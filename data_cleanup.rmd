...
gif <- 
ggplot(immigration_country_10, aes(x = country, y = total, color = country, fill = country)) +
 geom_col(alpha = 0.75) +
...
# create an immigration percetentage map
world_immigration <- world_immigration %>%
  mutate(immigration_percap = immigration/11/(pop_est /10000))
...
map_overall <- ggplot(data = world_immigration) +
          ...
          labs(title = "Total Immigration into US", subtitle = "Sum over 2007 - 2017, Top 5: Mexico, China, India, Philippines and Dominican Republic",
               caption = "Data Source: US Homeland Security, rnaturalearth Library",
               fill = "Immigrants")
